		...
		<vui-body>
			<div class="s-input">
				...
				<div>
					...
					<vui-input title="电话号码：" v-model="val2" type="tel" :regexp="regexp" :isReturn="return1" placeholder="请输入电话号码"
					 @change="change2">
					</vui-input>
				...
				<div>
					...
					<vui-input title="身份证号：" v-model="val3" type="id" placeholder="请输入身份证号" :regexp="regexpid" :isReturn="return2">
					</vui-input>
					<div class="btn" @click="output2">点击查看此次验证结果</div>
				</div>
				<div>
					<div class="title">身份证号的年龄校验（0-180岁）</div>
					<vui-input title="身份证号：" v-model="val4" type="id" :regexp="regexpid" :isReturn="return3" :maxage="180" :minage="0"
...
<script>
	import Vue from "vue";
	import VuiBody from "./vui-body"
	import VueHighlightJS from 'vue-highlightjs'
	import VuiInput from "../../../src/Input/index"
