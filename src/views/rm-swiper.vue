		...
		<div class="lr">
			...
			<rm-swiper @on-slide="slide" v-model="index" :loop="true" :auto="false" effect="slide" direction="horizontal" :pagination="true">
				<template slot="misty-slide-list">
					<div><img src="https://static.zhongan.com/website/tech/img/index/case_bg_qu_2.png" /></div>
					<div><img src="https://static.zhongan.com/website/tech/img/index/case_bg_qu_3.png" /></div>
					<div><img src="https://static.zhongan.com/website/tech/img/index/case_bg_qu_4.png" /></div>
					<div><img src="https://static.zhongan.com/website/tech/img/index/case_bg_qu_6.png" /></div>
				</template>
			</rm-swiper>
		</div>
		<div class="lr">
